...
// Get the proportionate height as per screen size
  ...
  Future<void> callPasswordApi(String email) async {
    try {
      ...
      var uri =
          'https://vact.tech/wp-json/wp/v2/forget_username?email=${email}';
      print(uri);
      ...
      if(tempObject['success'].toString()=="true"){
  ...
  //     var uri =
  //         'https://vact.tech/wp-json/wp/v2/forget_username?email=${email}&user_id=${userId}&otp=${otp}&password=${password}';
  //     //print(uri);
  //     var response = await post(Uri.parse(uri));
  //     //print('response :' + response.body);
